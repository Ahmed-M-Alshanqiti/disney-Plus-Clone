...
import serviceAccount from './disneyplus-clone-1342b-firebase-adminsdk-fbsvc-7c0806537a.json' assert { type: 'json' } // Download from Firebase Console

admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: 'https://disneyplus-clone-1342b-default-rtdb.firebaseio.com' // Replace with your DB URL
});
